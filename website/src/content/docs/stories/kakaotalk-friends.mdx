...
> **CQRS (Command Query Responsibility Segregation)**: Actionbase as a read-optimized view. Keep your existing write path; Actionbase syncs via CDC.

This is the story of how Actionbase became a new view layer for KakaoTalk's friend relationships.
...
Actionbase got the chance to prove itself here—not as a replacement, but as an additional view layer.
...
- **CDC enables non-invasive integration.** No changes to the write path required.
