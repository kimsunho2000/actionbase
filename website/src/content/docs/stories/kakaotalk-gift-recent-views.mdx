...
> **Async**: Decouple writes from processing. Queue high-frequency events to WAL and process them asynchronously.

This is the story of how Actionbase handled high-frequency writes for KakaoTalk Gift's recent views.
...
> **Note:** The async processor is currently internal. Open source release is in progress. See [Roadmap](/community/roadmap/).
