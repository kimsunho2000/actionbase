...
- 첫 프로덕션 서비스 쓰기/읽기 마이그레이션: [카카오톡 선물 위시](/ko/stories/use-cases/kakaotalk-gift-wish/)
...
- 커머스 도메인 전반에 적용되었습니다 (예: [카카오톡 선물하기 최근 조회](/ko/stories/use-cases/kakaotalk-gift-recent-views/))
...
- 여러 도메인에 적용되었습니다 (예: [카카오톡 친구](/ko/stories/use-cases/kakaotalk-friends/))
