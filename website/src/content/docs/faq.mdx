...
For high-frequency interactions (e.g., [recent views](/stories/kakaotalk-gift-recent-views/)), Actionbase uses async processing via Spark Streaming:
...
**Production** — documentation in progress, see [Roadmap](/community/roadmap/)
...
Yes — documentation in progress, see [Roadmap](/community/roadmap/).
