...
<Aside>This guide assumes a local, in-memory setup for quick evaluation.</Aside>
...
> Metadata management currently uses **v2 APIs** (service / label), while data read & write
> operations use **v3 APIs** (database / table).
